...
function showCustomer(str) {
  ...
  xhttp.open("GET", "CheckNewEmail?eml="+str, true);
  xhttp.send();
}
...
//function validate(){
	...
	//	document.getElementById("bottomrow").innerHTML = "<input type=\"submit\" value=\"lets go!\" >";
	//}
//}
</script>
...
<table>
	...
	<form action="Signup" method="post" >
		...
		<div id="txtHint"><jsp:expression >the_user.getMessage()</jsp:expression><br /></div>
		
		</td>
		<td class="theading" rowspan="9" style="width:152px; margin:0px; padding-left: 7px; padding-top: 7px; padding-right: 7px; padding-bottom: 0px;"><img src="images/dro-logo-dedede.png" width="130" height="65"  /></td>
	</tr><tr>
		<td ><label>First Name</label>  
		</td><td><input type="text" id="first_name" name="first_name" value="<%=the_user.getFirst_name()%>" /><br /></td>
	</tr><tr>
		<td><label>Last Name</label> </td>
		<td><input type="text" id="last_name" name="last_name" value="<%= the_user.getLast_name()%>" /></td>
	</tr><tr>
		<td><label>Email</label> </td>
		<td><input type="text" id="mem_email" name="mem_email" onblur="showCustomer(this.value)" <%= the_user.getEmail()%> /></td>
	</tr><tr>
	...
	<tr>
		...
		<td>&nbsp;</td><td ><div id="bottomrow">&nbsp;<input type="submit" id="subit" name="submit" value="Okay!" ></div></td>
	</tr>
	<tr>
