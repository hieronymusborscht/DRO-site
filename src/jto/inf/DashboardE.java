...
/**
 * Servlet implementation class DashboardE
 */
@WebServlet("/DashboardE")
public class DashboardE extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(the_user.isLogged_in()){
			request.getRequestDispatcher("employer_dash.jsp").forward(request, response);
		}else{
